...
- 這些 rendered artifact 是 phase 2 proof，不是正式 install source
- 正式 renderer / validator / install pipeline 會在 phase 3 實作
- 如果 proof artifact 與 canonical source 不一致，以 canonical source 為準
